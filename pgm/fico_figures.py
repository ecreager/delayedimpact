...
def main(unused_argv):
    ...
    # profit and impact
    utility_repaid_1 = gin.query_parameter('%utility_repaid_1')
    utility_default_1 = gin.query_parameter('%utility_default_1')
    utility_repaid_2 = gin.query_parameter('%utility_repaid_2')
    ...
    # qualitative results
    util_repay = [
        [utility_default_1, utility_repaid_1],
        [utility_default_2, utility_repaid_2]
        ]
